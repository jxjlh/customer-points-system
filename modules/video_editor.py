...
def show_video_editor() -> None:
    ...
    st.markdown('<div class="page-title">AI 视频剪辑 · Crayotter</div>', unsafe_allow_html=True)
    st.markdown('<div class="page-subtitle">一句话需求驱动三阶段工作流：Planner 素材规划 → Editing Research 剪辑研究蓝图 → ReAct Editor 工具执行出片</div>', unsafe_allow_html=True)
    st.divider()
